                    ...
                    <CardDeck>
                        <Card style={{ padding:'2em'}}>
                            ...
                            <Card.Body>
                                ...
                                <Nav.Link href = "/sviHoteli" ><button className="submit"  onClick = {()=>{localStorage.setItem("oviHoteli", "New York")}}>Pogledaj ponude!</button></Nav.Link>
                            </Card.Body>
                        </Card>
                        <Card style={{ padding:'2em'}}>
                            ...
                            <Card.Body>
                                ...
                                <Nav.Link href = "/sviHoteli" ><button className="submit"  onClick = {()=>{localStorage.setItem("oviHoteli", "Venecija")}}>Pogledaj ponude!</button></Nav.Link>
                            </Card.Body>
                            </Card>
                    </CardDeck>
                    ...
                    <CardDeck>
                        <Card style={{ padding:'2em'}}>
                            ...
                            <Card.Body>
                                ...
                                <Nav.Link href = "/sviHoteli" ><button className="submit"  onClick = {()=>{localStorage.setItem("oviHoteli", "Rim")}}>Pogledaj ponude!</button></Nav.Link>
                            </Card.Body>
                        </Card>
                        <Card style={{ padding:'2em'}}>
                            ...
                            <Card.Body>
                                ...
                                <Nav.Link href = "/sviHoteli" ><button className="submit"  onClick = {()=>{localStorage.setItem("oviHoteli", "Dubrovnik")}}>Pogledaj ponude!</button></Nav.Link>
                            </Card.Body>
                        </Card>
                    </CardDeck>
            </div>
