...
azurirajUposlenika(){
    ...
    if(!regexdatum.test(this.state.datumDolaska)){
    ...
    if(!regexdatum2.test(this.state.datumOdlaska)){
    ...
    var r = {
        ...
        datumDolaska: this.state.datumDolaska,
        datumOdlaska: this.state.datumOdlaska,
                ...
                <Row>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><Form.Control type="text" isInvalid = {this.state.datumDolaskaStatus} value = {this.state.datumDolaska}  onChange={(e)=>{
                                        this.setState({ 
                                            datumDolaska: e.target.value
                                        }) }}/> </td>
                        </tr>
                        <tr>
                            <th  style = {{textAlign: 'right'}}>Datum odlaska: </th>
                            <td><Form.Control type="text" isInvalid = {this.state.datumOdlaskaStatus} value = {this.state.datumOdlaska} onChange={(e)=>{
                                        this.setState({ 
                                            datumOdlaska: e.target.value,
                                            cijena: 500
                                        }) }}/> </td>
                        </tr>
                        <tr>
                            <th  style = {{textAlign: 'right'}}>Broj kreveta: </th>
                            <td><Form.Control type="number" min={1} isInvalid = {this.state.krevetaStatus}  onChange={(e)=>{
                                        this.setState({ 
                        ...
                        <tr>
                            ...
                            <td><Form.Control type="number" min={0} max={10} isInvalid = {this.state.djeceStatus} onChange={(e)=>{
                        ...
                        <tr>
                            ...
                            <td> <Form.Control required as="select" isInvalid = {this.state.radStatus} onChange={(val)=>{
                                if(val.target.value){
                                    this.setState({
                        ...
                        <tr>
                            ...
                            <td><Form.Control required as="select" isInvalid = {this.state.prevozStanje} onChange={(val)=>{
                        ...
                        <tr>
                            ...
                            <td><Form.Control required as="select" isInvalid = {this.state.osiguranjeStatus} onChange={(val)=>{
                                if(val.target.value){
                                    this.setState({
